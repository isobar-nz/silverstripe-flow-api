...
class StatusAdmin extends LeftAndMain implements PermissionProvider
{
    ...
    public function getEditForm($id = null, $fields = null)
    {
        ...
        $form->Fields()->addFieldsToTab('Root.Products', [
            ...
            LiteralField::create('ProductData', $this->renderWith('App\ModelAdmin\Includes\FlowStatusAdmin_status', [
        ...
        $form->Fields()->addFieldsToTab('Root.Stock', [
            ...
            LiteralField::create('StockData', $this->renderWith('App\ModelAdmin\Includes\FlowStatusAdmin_status', [
        ...
        $form->Fields()->addFieldsToTab('Root.Pricing', [
            ...
            LiteralField::create('PricingData', $this->renderWith('App\ModelAdmin\Includes\FlowStatusAdmin_status', [
